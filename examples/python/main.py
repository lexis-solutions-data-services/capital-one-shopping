"""
Example: How to call the capital-one-shopping actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/capital-one-shopping
...
def run_actor():
    """Run the capital-one-shopping actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/capital-one-shopping"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://capitaloneshopping.com/search?q=eyJzaXplIjo1MCwibWF0Y2giOiJuaWtlIiwiZnJvbSI6MCwiZmlsdGVycyI6eyJicmFuZHMiOlsiTmlrZSJdfSwic29ydCI6eyJwcmljZSI6ImRlc2MifX0%3D"}],
            "model": "PRODUCT",
            "maxItems": 20,
        }
    )
